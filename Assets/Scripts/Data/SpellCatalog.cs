...
namespace InkLine
{
    ...
    public static class SpellCatalog
    {
        ...
        // 共享一条能量，所以贵的技能天然和便宜的抢资源，这才有攒不攒的取舍。
        static readonly SpellDef[] All =
        {
            new SpellDef
            {
                Id = SpellId.Burst, Name = "墨爆", Desc = "最前排炸开一圈，6 点伤害",
                Energy = 25, Price = 0, Gate = 0, Tint = InkTheme.Explode
            },
            new SpellDef
            {
                Id = SpellId.Halt, Name = "定身", Desc = "全场敌人定住 1.6 秒",
                Energy = 35, Price = 40, Gate = 0, Tint = InkTheme.Word
            },
            new SpellDef
            {
                Id = SpellId.Rage, Name = "强攻", Desc = "5 秒内炮弹伤害翻倍",
                Energy = 45, Price = 75, Gate = 0, Tint = InkTheme.Fire
            },
            new SpellDef
            {
                Id = SpellId.Sweep, Name = "横扫", Desc = "全屏 5 点伤害并击退",
                Energy = 55, Price = 120, Gate = 14, Tint = InkTheme.Ink
            },
            new SpellDef
            {
                Id = SpellId.Splash, Name = "泼墨", Desc = "敌人最多那一列灼烧 3 秒",
                Energy = 50, Price = 160, Gate = 18, Tint = InkTheme.Poison
            },
            new SpellDef
            {
                Id = SpellId.Mend, Name = "回血", Desc = "基地回 1 血，每局限一次",
                Energy = 70, Price = 220, Gate = 0, NeedClear = true, Tint = InkTheme.Heart
            }
        };
